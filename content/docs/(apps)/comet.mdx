...
<h1 align="center" id="title">
    ☄️ Comet - <a href="https://discord.gg/rivenmedia">Discord</a>
</h1>

<p align="center">
    <img src="https://socialify.git.ci/g0ldyy/comet/image?description=1&font=Raleway&forks=1&issues=1&language=1&logo=https%3A%2F%2Fi.imgur.com%2FGj0KQwB.png&name=1&owner=1&pattern=Solid&pulls=1&stargazers=1&theme=Dark" />
</p>

<p align="center">
    <a href="https://ko-fi.com/E1E7ZVMAD">
        <img src="https://ko-fi.com/img/githubbutton_sm.svg"></img>
    </a>
</p>
...
-   Real-Debrid, All-Debrid, Premiumize, TorBox and Debrid-Link supported _(if you want other debrid services, please provide an account)_
...
1. Copy _compose.yaml_ in a directory
2. Copy _env-sample_ to _.env_ in the same directory
